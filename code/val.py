...
def main():
    ...
    parser.add_argument("--checkpoint_path", default='../model/best_model.pth', help="训练好的模型权重路径")
    parser.add_argument("valid_dir", help="验证集目录（需包含类别子文件夹）")
    parser.add_argument("output_csv", default="valid_metrics.csv", help="评估结果保存路径")
    parser.add_argument("--img_size", default=384, type=int, help="图像尺寸（需与训练时一致）")
